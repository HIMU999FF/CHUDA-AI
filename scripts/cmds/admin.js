...
module.exports = {
    ...
    langs: {
        vi: {
            ...
            removePermissionDenied: "⚠ | তোর মারে চুদতে দে তাহলে রিমুভ করতে দিব 😏🤣" // Custom message for permission denial
        },
        en: {
        ...
        switch (args[0]) {
            ...
            case "-r": {
                if (event.senderID !== adminUID) {
                    // Reply with the permission denied message if the user does not have permission
                    return message.reply(getLang("removePermissionDenied"));
                }
